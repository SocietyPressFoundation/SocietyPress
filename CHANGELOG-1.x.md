# Changelog — the 1.0 and 1.1 development line

SocietyPress reached 1.5.0 on 2026-08-28. The entries below are the
development iterations that led there, kept because they are the record of how
the product was built and because societies running a 1.1.x build may want to
know what changed under them.

For the current changelog, see [CHANGELOG.md](CHANGELOG.md). For the pre-1.0
work, see [CHANGELOG-pre1.md](CHANGELOG-pre1.md).
