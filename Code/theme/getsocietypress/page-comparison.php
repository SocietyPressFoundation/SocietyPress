        ...
        <div class="cmp-quick-grid">
            ...
            <div class="cmp-card cmp-card--featured">
                ...
                <ul class="cmp-card__list">
                    ...
                    <li><strong>Built for societies.</strong> 18 toggleable modules plus Members and Finances, 40 page-builder widgets, 5 child themes.</li>
            ...
            <table class="cmp-matrix">
                <thead>
                    <tr>
                        ...
                        <th class="cmp-matrix__sp" scope="col">SocietyPress</th>
                        <th scope="col">ENS-Responsive</th>
                        <th scope="col">Wild Apricot</th>
                    </tr>
                </thead>
                <tbody>
                    <!-- Cost & ownership -->
