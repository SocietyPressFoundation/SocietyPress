...
$gsp_founding_society = array(
    array(
        'name' => 'San Antonio Genealogical and Historical Society',
        'url'  => 'https://www.rootsweb.com/~txsaghs/',
...
$gsp_contributors = array(
    ...
    array(
        ...
        'description' => 'SAGHS webmaster whose experience on ENS informed the ENS migration path and the 73-field CSV importer.',
    ),
);
