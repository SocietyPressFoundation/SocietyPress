...
### 18. Hardcoded the society References in Store
- **Location:** `sp_render_store_frontend()` (line ~43455) — filters by `acq_code = 'Society Publication'` and uses the society-specific intro copy
