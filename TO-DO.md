...
- [x] PHP 8 compatibility fix (null in add_submenu_page)
...
- [ ] Dashboard widgets (expiring soon, recent signups)
...
- [ ] Internationalization (i18n) - strings are wrapped, need .pot file
- [ ] Accessibility audit
