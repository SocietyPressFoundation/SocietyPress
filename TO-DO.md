...
- [x] Skip navigation link (WCAG 2.4.1) — parent theme + SAGHS + all 6 templates
...
- [ ] Showcase page: at least one real site (SAGHS/kndgs.org once it's live)
...
- [ ] Case study: SAGHS as the reference implementation — "here's a real society running SocietyPress"
