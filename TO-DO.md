...
- [x] Store: Public-facing storefront (/store/) for the society publications — category sidebar with counts, product card grid, quantity selector, placeholder Add to Cart buttons, responsive layout
