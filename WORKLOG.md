...
- Removed the society from themes page (stale plugin on server had it in registry)
...
- Same fallback added to the society child theme header.php
...
- Desktop search form hidden in the society child theme
- Nav right-justified, gap between nav and user menu eliminated
- the society logo switched from fixed-size SVG to scalable JPG

**the society Child Theme (0.08d):**
