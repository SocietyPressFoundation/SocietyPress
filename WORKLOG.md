...
**Why:** Only 2 the society members lack email addresses. Rather than block the entire record, allow saving without email and show a warning.
...
**Testing:**
- Tested installer on example.org (production domain)
...
**Current Test Status:**
- example.org wiped and ready for fresh installer test
