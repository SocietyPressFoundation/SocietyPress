 ...
 * (so SAGHS overrides win). It also registers a footer nav menu and enqueues
 * the SAGHS-specific JavaScript for hamburger toggle, dropdown nav, and the
 * hero slider.
 *
...
define( 'SAGHS_THEME_VERSION', '0.01d' );
...
/**
 * Load parent + child stylesheets and SAGHS JavaScript.
 *
 ...
 * 2. Child style.css  (SAGHS color overrides, custom components)
 * 3. saghs.js         (hamburger, dropdowns, hero slider)
 */
