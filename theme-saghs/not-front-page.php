 ...
 *
 * WHY: The SAGHS homepage has a unique layout that doesn't match the parent's
 * generic page.php. It needs a hero slider, events section, library callout,
 * and feature cards — all specific to SAGHS's identity and content.
 *
...
<main class="saghs-front-page">
    ...
    ?>
        <div class="saghs-hero" id="saghs-hero">
            <div class="saghs-hero-slide is-active"
                 <?php if ( $hero_image ) : ?>
                 style="background-image: url('<?php echo esc_url( $hero_image ); ?>');"
                 <?php else : ?>
                 style="background: var(--saghs-burgundy);"
                 <?php endif; ?>
            >
            </div>
            <div class="saghs-hero-overlay">
    ...
    // =========================================================================
    // WHY: SAGHS runs regular classes and workshops. Showing the next few events
    ...
    ?>
    <section class="saghs-section saghs-section-white">
        <div class="saghs-section-inner">
            <h2 class="saghs-section-heading">Classes &amp; Events</h2>
            <hr class="saghs-divider">
            ...
            ?>
                <a href="<?php echo esc_url( get_permalink( $events_pages[0]->ID ) ); ?>" class="saghs-more-link">
    ...
    // =========================================================================
    // WHY: The SAGHS library is a major draw — over 18,000 items. This callout
    ...
    ?>
    <section class="saghs-section saghs-section-cream">
        <div class="saghs-section-inner">
            <h2 class="saghs-section-heading">Our Library</h2>
            <hr class="saghs-divider">

            <div class="saghs-library-callout">
                <div class="saghs-library-image">
                    <!--
                    ...
                    <img src="<?php echo esc_url( get_stylesheet_directory_uri() . '/images/library-placeholder.jpg' ); ?>"
                         alt="SAGHS Library interior"
                         onerror="this.style.display='none'">
                </div>
                <div class="saghs-library-text">
                    ...
                    <a href="<?php echo esc_url( $library_url ); ?>" class="saghs-btn saghs-btn-primary">
                        Browse the Catalog
                    </a>
                </div>
            </div>
    ...
    <section class="saghs-section saghs-section-cream">
        <div class="saghs-section-inner">
            <div class="saghs-features-grid">

                <div class="saghs-feature-card">
                    <img src="<?php echo esc_url( get_stylesheet_directory_uri() . '/images/volunteer-placeholder.jpg' ); ?>"
                         alt="Volunteers at SAGHS"
                         onerror="this.style.background='var(--saghs-cream)'; this.style.minHeight='160px';">
                    <h3>Volunteer</h3>
                    <p>
                    ...
                    <a href="<?php echo esc_url( home_url( '/volunteer/' ) ); ?>" class="saghs-btn saghs-btn-dark">
                        Get Involved
                    </a>
                </div>
                ...
                <div class="saghs-feature-card">
                    <img src="<?php echo esc_url( get_stylesheet_directory_uri() . '/images/learn-placeholder.jpg' ); ?>"
                         alt="SAGHS workshop in progress"
                         onerror="this.style.background='var(--saghs-cream)'; this.style.minHeight='160px';">
                    <h3>Learn</h3>
                    <p>
                    ...
                    ?>
                    <a href="<?php echo esc_url( $events_url ); ?>" class="saghs-btn saghs-btn-dark">
                        View Classes
                    </a>
                </div>
                ...
                <div class="saghs-feature-card">
                    <img src="<?php echo esc_url( get_stylesheet_directory_uri() . '/images/benefits-placeholder.jpg' ); ?>"
                         alt="SAGHS library resources"
                         onerror="this.style.background='var(--saghs-cream)'; this.style.minHeight='160px';">
                    <h3>Member Benefits</h3>
                    <p>
                        Free, unlimited use of the SAGHS Library, access to online
                        databases, monthly newsletters, research assistance, and
                        affiliation with state and national societies.
                    </p>
                    <a href="<?php echo esc_url( home_url( '/join/' ) ); ?>" class="saghs-btn saghs-btn-dark">
                        Join Today
                    </a>
                </div>
